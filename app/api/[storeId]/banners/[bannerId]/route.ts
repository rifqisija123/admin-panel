...
export async function PATCH (
    ...
    try {
        ...
        if(!label) {
            return new NextResponse("Harus Menginputkan Label Terlebih Dahulu", { status: 400 });
        }

        if(!imageUrl) {
            return new NextResponse("Harus Menginputkan ImageUrl Terlebih Dahulu", { status: 400 });
        }
